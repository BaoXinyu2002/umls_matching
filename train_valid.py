...
parser.add_argument('--left_w2v_dir', type=str, default='/nfs/turbo/umms-drjieliu/usr/xinyubao/owl2vec/OWL2Vec-Star/cache/output/ncit-doid',
                    help='OWL2Vec or Word2Vec of the left ontology')
parser.add_argument('--right_w2v_dir', type=str, default='/nfs/turbo/umms-drjieliu/usr/xinyubao/owl2vec/OWL2Vec-Star/cache/output/ncit-doid',
...
start = datetime.now()
# left_wv_model = dill.load(open("/nfs/turbo/umms-drjieliu/usr/xinyubao/logmap_ml/OntoAlign/LogMap-ML/data/ncit_embeding",'rb'))
# right_wv_model = dill.load(open("/nfs/turbo/umms-drjieliu/usr/xinyubao/logmap_ml/OntoAlign/LogMap-ML/data/doid_embeding",'rb'))
