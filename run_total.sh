#!/bin/bash
source_onto="anatomy/bto.owl" # the path of the source ontology
target_onto="anatomy/efo.owl" # the path of the target ontology
...
left_w2v_dir="embedding/anatomy" # path of the source ontology embedding
right_w2v_dir="embedding/anatomy" # path of the target ontology embedding
candidate_file="logmap_output/logmap_overestimation.txt" # the oversetimation is generated by logmap
prediction_out_file="/nfs/turbo/umms-drjieliu/usr/xinyubao/umls_matching/anatomy/predicted_bto_efo_candidates.tsv" # output of predict_candidates.py
selection_result="/nfs/turbo/umms-drjieliu/usr/xinyubao/umls_matching/output/bto_efo_selection.tsv" # output of map_selection.py
source_prefix="http://purl.obolibrary.org/obo/" # prefix of the source ontology.
target_prefix="http://purl.obolibrary.org/obo/" # prefix of the target ontology
reference_mapping="logmap_output/logmap_mappings.tsv" # reference mapping
