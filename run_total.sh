...
prediction_out_file="/nfs/turbo/umms-drjieliu/usr/xinyubao/umls_matching/predicted_candidates.tsv" # output of predict_candidates.py
selection_result="/nfs/turbo/umms-drjieliu/usr/xinyubao/umls_matching/selection.tsv" # output of map_selection.py
